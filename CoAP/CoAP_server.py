...
class handle_10MB_file(resource.Resource):
	async def render_get(self,request):
		...
		try:
			...
			raise aiocoap.error.ResourceNotFound()	
			
class handle_100B_file(resource.Resource):
	async def render_get(self,request):
		file_path = '/home/sandesh/mqtt_project/100B'
		try:
			with open(file_path, 'rb') as file:
				payload = file.read()
			return aiocoap.Message(payload=payload)
...
class handle_10KB_file(resource.Resource):
	async def render_get(self,request):
		file_path = '/home/sandesh/mqtt_project/10KB'
		try:
			with open(file_path, 'rb') as file:
				payload = file.read()
			return aiocoap.Message(payload=payload)
...
class handle_1MB_file(resource.Resource):
	async def render_get(self,request):
		file_path = '/home/sandesh/mqtt_project/1MB'
		try:
			with open(file_path, 'rb') as file:
				payload = file.read()
			return aiocoap.Message(payload=payload)
...
async def main():
    ...
    root = resource.Site()
    root.add_resource(['10MB'], handle_10MB_file())
    root.add_resource(['100B'], handle_100B_file())
    root.add_resource(['1MB'], handle_1MB_file())
    root.add_resource(['10KB'], handle_10KB_file())
